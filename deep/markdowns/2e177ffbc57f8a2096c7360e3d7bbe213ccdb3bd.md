# kdense/verify-skill-folders-are-in-the-correct-directory-see-getting-started-getting-started
...
| 字段 | 内容 |
|---|---|
| 名称 | kdense/verify-skill-folders-are-in-the-correct-directory-see-getting-started-getting-started |
