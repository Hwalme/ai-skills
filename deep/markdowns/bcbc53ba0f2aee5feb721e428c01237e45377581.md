...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/TensorRT-LLM/exec-slurm-compile |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/exec-slurm-compile |
...
- https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/exec-slurm-compile
