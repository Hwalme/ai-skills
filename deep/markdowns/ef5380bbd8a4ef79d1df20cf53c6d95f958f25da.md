...
| 字段 | 内容 |
|---|---|
| 名称 | yikuansun/photopeaapi |
| 链接 | https://github.com/yikuansun/PhotopeaAPI |
...
```html
<script src="https://cdn.jsdelivr.net/npm/photopea@1.1.2/dist/photopea.min.js"></script>
```
...
- https://github.com/yikuansun/PhotopeaAPI
