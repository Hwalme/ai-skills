# testmu-ai/mocha-skill

> Generate Mocha tests in JavaScript with Chai and Sinon

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/mocha-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/mocha-skill |
...
- https://github.com/LambdaTest/agent-skills/tree/main/mocha-skill
