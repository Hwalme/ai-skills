# testmu-ai/behat-skill

> Generate Behat BDD tests for PHP with Gherkin and Mink

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/behat-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/behat-skill |
