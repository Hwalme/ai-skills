# openmontage/documentary-montage

> 视频管线: Thematic montage cut from a CLIP-indexed corpus of free stock footage and open archives (Pexels, Archive.org, NASA, Wikimedia, Unsplash)（适用: Video essays, mood pieces, retrieval-first B-roll edits, real-footage videos without paid generation APIs）

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | openmontage/documentary-montage |
