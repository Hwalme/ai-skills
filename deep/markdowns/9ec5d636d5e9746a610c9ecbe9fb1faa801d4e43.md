# openmontage/composition-html-gsap

> 视频管线: HyperFrames（适用: HTML/CSS/GSAP rendering — kinetic typography, product promos, launch reels, registry blocks, website-to-video, rigged SVG character animation）

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | openmontage/composition-html-gsap |
