...
> Generate Vitest tests in JS/TS with a Jest-compatible API and ESM

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/vitest-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/vitest-skill |
