...
| 字段 | 内容 |
|---|---|
| 名称 | Rootly-AI-Labs/rootly-incident-responder |
| 链接 | https://github.com/Rootly-AI-Labs/Rootly-MCP-server/blob/main/examples/skills/rootly-incident-responder.md |
