...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/TensorRT-LLM/exec-local-compile |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/exec-local-compile |
...
- https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/exec-local-compile
