# testmu-ai/nemojs-skill

> Generate Nemo.js Selenium-based tests for Node.js

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/nemojs-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/nemojs-skill |
