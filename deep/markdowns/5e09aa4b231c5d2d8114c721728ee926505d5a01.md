...
| 字段 | 内容 |
|---|---|
| 名称 | stareezy-1/frontend-architecture-skill |
| 链接 | https://github.com/stareezy-1/frontend-architecture-skill |
...
Type safety at the **network edge**. One typed `apiClient` is the only place `

> *（内容过长，已截断前 15000 字符。完整文档见原链接）*

## 参考链接

- https://github.com/stareezy-1/frontend-architecture-skill
