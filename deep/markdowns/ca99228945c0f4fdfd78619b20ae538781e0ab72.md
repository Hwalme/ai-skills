...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/update-golden-values |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/update-golden-values |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/update-golden-values
