...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Bridge/multi-node-slurm |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Bridge/multi-node-slurm |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Bridge/multi-node-slurm
