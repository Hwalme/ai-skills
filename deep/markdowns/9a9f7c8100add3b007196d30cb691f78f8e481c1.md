# openmontage/animation

> 视频管线: Motion graphics, kinetic typography, animated sequences（适用: Social media, product demos, abstract concepts）

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | openmontage/animation |
