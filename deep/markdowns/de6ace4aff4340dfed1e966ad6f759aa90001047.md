# testmu-ai/xunit-skill

> Generate xUnit.net tests in C# with Fact/Theory and FluentAssertions

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/xunit-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/xunit-skill |
...
- https://github.com/LambdaTest/agent-skills/tree/main/xunit-skill
