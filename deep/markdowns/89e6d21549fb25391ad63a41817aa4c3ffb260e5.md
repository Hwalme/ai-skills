# kdense/re-run-gh-skill-install-k-dense-ai-scientific-agent-skills-after-pulling-the-latest-release
...
| 字段 | 内容 |
|---|---|
| 名称 | kdense/re-run-gh-skill-install-k-dense-ai-scientific-agent-skills-after-pulling-the-latest-release |
