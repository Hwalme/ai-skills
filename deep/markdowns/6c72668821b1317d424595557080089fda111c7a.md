# testmu-ai/testng-skill

> Generate TestNG tests in Java with data providers and parallel execution

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/testng-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/testng-skill |
