...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/onboard-gb200-1node-tests |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/onboard-gb200-1node-tests |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/onboard-gb200-1node-tests
