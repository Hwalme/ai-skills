# testmu-ai/xcuitest-skill

> Generate XCUITest UI tests for iOS/iPadOS apps in Swift

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/xcuitest-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/xcuitest-skill |
