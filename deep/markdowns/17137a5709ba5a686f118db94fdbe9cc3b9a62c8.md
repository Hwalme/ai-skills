...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/nemotron-voice-agent/nemotron-voice-agent-deploy |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/nemotron-voice-agent/nemotron-voice-agent-deploy |
...
- https://github.com/NVIDIA/skills/tree/main/skills/nemotron-voice-agent/nemotron-voice-agent-deploy
