# testmu-ai/reqnroll-skill

> Generate Reqnroll BDD tests for web and mobile in C#

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/reqnroll-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/reqnroll-skill |
