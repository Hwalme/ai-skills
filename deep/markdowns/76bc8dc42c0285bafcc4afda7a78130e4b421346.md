...
| 字段 | 内容 |
|---|---|
| 名称 | 2slides/slides-generation-2slides-skills |
| 链接 | https://github.com/2slides/slides-generation-2slides-skills |
...
This skill integrates with the 2slides API service. Usage is subject to 2sl
