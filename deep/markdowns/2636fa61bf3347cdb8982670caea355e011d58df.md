...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/TensorRT-LLM/ad-model-onboard |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/ad-model-onboard |
...
- https://github.com/NVIDIA/skills/tree/main/skills/TensorRT-LLM/ad-model-onboard
