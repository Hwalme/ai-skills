...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/run-on-slurm |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/run-on-slurm |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/run-on-slurm
