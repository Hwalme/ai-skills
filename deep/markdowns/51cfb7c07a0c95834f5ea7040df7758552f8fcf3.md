# testmu-ai/nunit-skill

> Generate NUnit 3 tests in C# with the constraint model and Moq

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/nunit-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/nunit-skill |
