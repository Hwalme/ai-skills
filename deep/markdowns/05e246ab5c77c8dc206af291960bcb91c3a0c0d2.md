# testmu-ai/specflow-skill

> Generate SpecFlow BDD tests for C#/.NET with Gherkin and step bindings

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/specflow-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/specflow-skill |
