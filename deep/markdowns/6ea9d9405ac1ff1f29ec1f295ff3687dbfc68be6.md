# testmu-ai/selenide-skill

> Generate Selenide UI tests in Java with auto-waits and a fluent API

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/selenide-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/selenide-skill |
