# testmu-ai/rspec-skill

> Generate RSpec tests in Ruby with matchers, hooks, and mocking

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/rspec-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/rspec-skill |
