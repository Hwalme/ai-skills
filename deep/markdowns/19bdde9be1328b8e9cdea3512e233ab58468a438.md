...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/bump-base-image |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/bump-base-image |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/bump-base-image
