...
> Let your AI agents join Google Meet, Zoom, Teams calls and collaborate like a real team-mate.

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | pattern-ai-labs/agentcall |
| 链接 | https://github.com/pattern-ai-labs/agentcall |
