...
| 字段 | 内容 |
|---|---|
| 名称 | xi-kari/crossframe-skill |
| 链接 | https://github.com/xi-kari/crossframe-skill |
...
python scripts/validate_crossframe_max_route_ledger_fixtures.py
python scripts/validate_crossframe_max_repair_fixtures.py
python scripts/build_crossframe_max_repair_plan.py --workspace <artifact-dir> --write-report --write-repair-

> *（内容过长，已截断前 15000 字符。完整文档见原链接）*

## 参考链接

- https://github.com/xi-kari/crossframe-skill
