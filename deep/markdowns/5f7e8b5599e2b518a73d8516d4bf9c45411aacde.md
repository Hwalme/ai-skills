...
| 字段 | 内容 |
|---|---|
| 名称 | addyosmani/agent-skills.git |
| 链接 | https://github.com/addyosmani/agent-skills.git |
...
| [shipping-and-launch](skills/shipping-and-launch/SKILL.md) | Pre-l
