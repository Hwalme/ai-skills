...
| 字段 | 内容 |
|---|---|
| 名称 | deanpeters/epic-hypothesis |
| 链接 | https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/epic-hypothesis |
| 来源聚合 | Product Manager Skills by Dean Peters |
| 分类路径 | AIGC创作 / 生图 / 电商图 |
...
|---|---|
| **Frontmatter** | `name`, `description`, `type`, `in
