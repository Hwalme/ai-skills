# openmontage/clip-factory

> 视频管线: Batch of ranked short-form clips from one long source（适用: Repurposing long content for social media）

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | openmontage/clip-factory |
