...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/cuopt/cuopt-user-rules |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/cuopt/cuopt-user-rules |
...
- https://github.com/NVIDIA/skills/tree/main/skills/cuopt/cuopt-user-rules
