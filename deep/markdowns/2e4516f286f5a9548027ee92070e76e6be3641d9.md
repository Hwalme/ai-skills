...
> Animated technical diagrams from plain English or Mermaid, self-contained HTML/SVG

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | csthink/dashmotion |
| 链接 | https://github.com/csthink/dashmotion/tree/main/skills/dashmotion |
...
- https://github.com/csthink/dashmotion/tree/main/skills/dashmotion
