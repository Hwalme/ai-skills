...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/split-pr |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/split-pr |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/split-pr
