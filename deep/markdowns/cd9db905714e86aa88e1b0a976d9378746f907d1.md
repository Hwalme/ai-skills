...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/NeMo-Evaluator/byob |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/NeMo-Evaluator/byob |
...
- https://github.com/NVIDIA/skills/tree/main/skills/NeMo-Evaluator/byob
