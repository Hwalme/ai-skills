# openmontage/composition-react

> 视频管线: Remotion（适用: React-based rendering — spring-animated image scenes, text cards, stat cards, charts, TikTok-style word-level captions, TalkingHead）

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | openmontage/composition-react |
