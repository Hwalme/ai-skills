# Orkas-AI/video-router

> Route video requests through deterministic agent production stages

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | Orkas-AI/video-router |
| 链接 | https://github.com/Orkas-AI/Orkas-VideoStudio/tree/main/packages/skills/video-router |
...
- https://github.com/Orkas-AI/Orkas-VideoStudio/tree/main/packages/skills/video-router
