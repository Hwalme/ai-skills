# kdense/update-manual-copy-paths-bookmarks-and-citations-from-scientific-skills-name-to-skills-name
...
| 字段 | 内容 |
|---|---|
| 名称 | kdense/update-manual-copy-paths-bookmarks-and-citations-from-scientific-skills-name-to-skills-name |
