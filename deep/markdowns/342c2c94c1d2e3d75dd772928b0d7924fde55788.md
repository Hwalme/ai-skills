...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/cicd |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/cicd |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/cicd
