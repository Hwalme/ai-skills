...
| 字段 | 内容 |
|---|---|
| 名称 | deanpeters/user-story-mapping-workshop |
| 链接 | https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/user-story-mapping-workshop |
| 来源聚合 | Product Manager Skills by Dean Peters |
| 分类路径 | 产品PM / 用户研究 / 用户/调研 |
