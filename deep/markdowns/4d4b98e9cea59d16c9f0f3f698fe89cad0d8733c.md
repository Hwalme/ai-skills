# testmu-ai/testcafe-skill

> Generate TestCafe automation tests in JavaScript or TypeScript

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/testcafe-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/testcafe-skill |
