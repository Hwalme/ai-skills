...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/respond-to-issue |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/respond-to-issue |
| 来源聚合 | Skills by NVIDIA |
| 分类路径 | 科研与数据 / 科研学术 / 生物信息/基因组 |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/respond-to-issue
