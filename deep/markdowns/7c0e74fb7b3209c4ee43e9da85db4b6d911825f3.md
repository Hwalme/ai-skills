...
> Automate authenticated browsers with extraction and human handoff

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | browser-act/browser-act |
| 链接 | https://github.com/browser-act/skills/tree/main/browser-act |
