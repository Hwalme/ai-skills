# testmu-ai/testunit-skill

> Generate Test::Unit xUnit-style tests in Ruby

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | testmu-ai/testunit-skill |
| 链接 | https://github.com/LambdaTest/agent-skills/tree/main/testunit-skill |
