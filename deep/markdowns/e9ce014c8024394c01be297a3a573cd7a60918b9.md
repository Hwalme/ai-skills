...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/NeMo-RL/config-conventions |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/NeMo-RL/config-conventions |
...
- https://github.com/NVIDIA/skills/tree/main/skills/NeMo-RL/config-conventions
