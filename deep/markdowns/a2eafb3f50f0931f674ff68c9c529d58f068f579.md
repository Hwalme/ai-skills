...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/create-issue |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/create-issue |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/create-issue
