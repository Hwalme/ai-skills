# kdense/if-a-skill-wraps-or-documents-an-external-package-database-or-platform-cite-that-upstream-project-too-when-your-field-s-norms-require-it
...
| 字段 | 内容 |
|---|---|
| 名称 | kdense/if-a-skill-wraps-or-documents-an-external-package-database-or-platform-cite-that-upstream-project-too-when-your-field-s-norms-require-it |
