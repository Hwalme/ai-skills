...
| 字段 | 内容 |
|---|---|
| 名称 | NVIDIA/Megatron-Core/nightly-sync |
| 链接 | https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/nightly-sync |
...
- https://github.com/NVIDIA/skills/tree/main/skills/Megatron-Core/nightly-sync
