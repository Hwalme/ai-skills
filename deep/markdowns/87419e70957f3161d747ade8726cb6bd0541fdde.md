...
> 18 go-to-market skills for solo technical founders: positioning, first users, launch, pricing, and founder-led sales; grounded in Adam Frankl and Jakub Czakon

## 基本信息

| 字段 | 内容 |
|---|---|
| 名称 | AIDevGTM/gtm-cofounder |
| 链接 | https://github.com/AIDevGTM/gtm-cofounder |
| 来源聚合 | Marketing |
| 分类路径 | 营销增长 / 广告投放 / 广告 |
