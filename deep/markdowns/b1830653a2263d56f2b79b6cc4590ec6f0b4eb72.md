...
| 字段 | 内容 |
|---|---|
| 名称 | antonbabenko/terraform-skill |
| 链接 | https://github.com/antonbabenko/terraform-skill |
...
- [AWS Terraform Best Practices](https://docs.aws.amazon.com/prescriptive-guidance/latest/
