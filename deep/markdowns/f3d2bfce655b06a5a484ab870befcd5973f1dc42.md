...
> Discover and call external paid tools for Claude Code agents instead of stopping to ask the user to sign up or fetch an API key
...
|---|---|
| 名称 | zero/zero |
| 链接 | https://github.com/officialzeroxyz/zero-plugins/blob/main/plugins/zero/skills/zero/SKILL.md |
| 来源聚合 | Skills by Zero |
| 分类路径 | 开发工程 / 后端与API / 后端 |
...
- https://github.com/officialzeroxyz/zero-plugins/blob/main/plugins/zero/skills/zero/SKILL.md
