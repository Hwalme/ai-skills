...
| 字段 | 内容 |
|---|---|
| 名称 | Lum1104/understand-anything |
...
- **Tree-sitter (deterministic)** — parses source into a concrete syntax tree and extracts structural facts: imports, exports, function/class definitions, call sites, inheritance
